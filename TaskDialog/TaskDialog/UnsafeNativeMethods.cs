...
namespace WindowsTaskDialog
{
    ...
    internal static partial class UnsafeNativeMethods
    {
        ...
        /// <param name="uNotification">The notification being passed.</param>
        ...
        internal delegate int TaskDialogCallback([In] IntPtr hwnd, [In] uint uNotification, [In] UIntPtr wParam, [In] IntPtr lParam, [In] IntPtr refData);
        ...
        /// <returns>The return value specifies the result of the message processing; it depends on the message sent.</returns>
        [DllImport("user32.dll", EntryPoint = "SendMessage", PreserveSig = false)]
        internal static extern IntPtr SendMessageWithTaskDialogConfig(IntPtr hWnd, uint Msg, IntPtr wParam, [In] ref TASKDIALOGCONFIG pTaskConfig);
