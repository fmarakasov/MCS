...
{
    internal partial class TaskDialogRadioButton : RadioButton
    {
        private int textLeftMargin = 0; //6;
        ...
        private bool onSizeChangedAutoSizeHeightDone = false;
        ...
        #region public override bool AutoSize
        /// <summary>
        /// When 'AutoSize' is set to true, 'AutoSizeHeight' is set to false.
        /// </summary>
        public override bool AutoSize
        {
            ...
            set
            {
                if (value) autoSizeHeight = false;
                base.AutoSize = value;
            }
        }
        #endregion

        #region public bool AutoSizeHeight
        /// <summary>
        /// When 'AutoSizeHeight' is set to true, 'AutoSize' is set to false.
        /// </summary>
        public bool AutoSizeHeight
        {
            set
            {
                bool autoSizeHeightOld = autoSizeHeight;
                autoSizeHeight = value;
                if (autoSizeHeight)
                {
                    AutoSize = false;
                    if (autoSizeHeight != autoSizeHeightOld) OnSizeChanged(null);
                }
            }
            get
            {
        ...
        protected override void OnLayout(LayoutEventArgs levent)
        {
            ...
            int paddingTop = (Font.Height - imageSize.Height) - 1;
        ...
        /// <summary>
        /// Calculates height when size changes and 'AutoSizeHeight' is set to true.
        /// </summary>
        /// <param name="e"></param>
        protected override void OnSizeChanged(EventArgs e)
        {
            if (AutoSizeHeight && !onSizeChangedAutoSizeHeightDone)
            {
                Size newSize = GetPreferredSize(new Size(Size.Width, Int32.MaxValue));
                if (Height != newSize.Height)
                {
                    onSizeChangedAutoSizeHeightDone = true;
                    Height = newSize.Height;
                    onSizeChangedAutoSizeHeightDone = false;
                    return;
                }
            }
