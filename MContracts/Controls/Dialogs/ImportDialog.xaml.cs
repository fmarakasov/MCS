...
namespace MContracts.Dialogs
{
    ...
    /// </summary>
    public partial class ImportDialogWindow : Window, IDisposable
    {
        ImporterViewModel _dataContext;




        public ImportDialogWindow(IContractRepository _repository)
        {
            InitializeComponent();

            // Insert code required on object creation below this point.
            
            _dataContext = new ImporterViewModel(_repository);
            ...
            _dataContext.SavingSetting = ImporterSavingSetting.SaveNew;
        ...
        public ImportDialogWindow(ImporterViewModel viewmodel): base()
        {
        ...
        public Schedulecontract CurrentSchedule
        {
            ...
            set
            {
                ...
                if (value != null) 
                {
                    ...
                    (_dataContext.Importer as Importer).InitSteps += OnInitSteps;
                    (_dataContext.Importer as Importer).NextStep += OnMakeStep;
                }
                else
                {
                    PriceColumn.Header = "Сумма, руб.";
        ...
        private void txtXLRightCol_TextChanged(object sender, TextChangedEventArgs e)
        {
