...
namespace McReports.ViewModel
{
    ...
    /// </summary>
    public class SubContractRegisterReportViewModel: ExcelReportViewModel
    {
        ...
        protected override string MaxExcelColumn
        {
         ...
         public SubContractRegisterReportViewModel(IContractRepository contractRepository):base(contractRepository)
         {
         ...
         protected override string OutputFileName
         {
             get
             {
                 return string.Format("Перечень договоров с соисполнителями за {0} год", Year.ToString());
        ...
        private List<SubContractDto> _contracts
         {
             get
             {
                 ...
                 IEnumerable<Contractdoc> cds = GetActiveСontractDocs();
                 if (cds != null && cds.Any())
                 {
                     var contractdocs = cds.Where(c => c.HasSubcontracts);
                     var e =
                         contractdocs.Aggregate(new List<SubContractDto>(), (a, g) =>
                                      {
                                       //Суб договор должен иметь КП с этапами
                                          a.AddRange(g.SubContracts.Where(s => s.HasSchedule && s.Stages != null && s.Stages.Any()).
                                                                           ...
                                                                           sts.Add(new SubContractDto()
                                                                            {
                                                                                ...
                                                                                ContractType = g.Contracttype ?? Repository.Contracttypes.FirstOrDefault(x=>x.WellKnownType == WellKnownContractTypes.Undefined),
                                                                                ...
                                                                                Directors = sub.DirectorsAndChiefs(true),
        ...
        private IEnumerable<Contractdoc> GetActiveСontractDocs()
         {
             ...
             return ActiveContractDocs.Where(
        ...
        protected override void BuildReport()
        {
            ...
            var reporter = CreateProgressReporter(subContractStages.Count());
