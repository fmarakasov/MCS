/*
Система учёта договоров 1.19
Скрипт сгенерирован 12:36:28 AM 26/04/2011
*/
...
CREATE TABLE Responsible (
  ...
  EmployeeID number(10) NOT NULL, 
  PRIMARY KEY (ID), 
  CONSTRAINT U_DISPOSAL_EMPLOYEE 
    UNIQUE (DisposalID, EmployeeID));
...
CREATE TABLE StageResult (
  ...
  CONSTRAINT U_STAGE_RESULT 
    UNIQUE (EconomicEfficiencyTypeID, StageID, NTPSubViewID));
...
VALUES 
  (1, 2000, 1, '01.01.2010', '31.12.2011', '27.01.2009', '27.01.2010', '1001-10-1', null, 1, null, 1, 600, 30, 1, 1, 1, 1, 7, null, 'Разработка и внедрение новых технологических регламентов «Газораспределительные системы. Система управления сетями газораспределения»', null, null, 'Договор имеет 3 субподрядных договора ID = 2,3,4 и 1 доп. соглашение ID=5', 5, 1, 1, null, null);
INSERT INTO ContractDoc
  (ID, Price, ContractTypeID, StartAt, EndsAt, AppliedAt, ApprovedAt, InternalNum, ContractorNum, CurrencyID, OriginContractID, NDSAlgorithmID, PrepaymentSum, PrepaymentPercent, PrepaymentNDSAlgorithmID, NDSID, ContractStateID, CurrencyMeasureID, ContractorID, IsProtectability, Subject, CurrencyRate, RateDate, Description, ContractorPersonID, IsActive, AuthorityID, PrepaymentPrecentType, Deleted) 
VALUES 
  (2, 323, 1, '01.10.2010', '18.10.2010', '20.05.2009', '20.05.2009', '124-04-01', null, 1, null, 1, null, null, null, 1, 1, 1, 1, null, 'Разработка технологического регламента', null, null, 'Субподрядное соглашение к ID=1', 2, 1, 1, null, null);
INSERT INTO ContractDoc
  (ID, Price, ContractTypeID, StartAt, EndsAt, AppliedAt, ApprovedAt, InternalNum, ContractorNum, CurrencyID, OriginContractID, NDSAlgorithmID, PrepaymentSum, PrepaymentPercent, PrepaymentNDSAlgorithmID, NDSID, ContractStateID, CurrencyMeasureID, ContractorID, IsProtectability, Subject, CurrencyRate, RateDate, Description, ContractorPersonID, IsActive, AuthorityID, PrepaymentPrecentType, Deleted) 
VALUES 
  (3, 500, 1, '10.01.2010', '27.12.2011', '15.03.2009', '15.03.2009', '300-06-1', null, 1, null, 1, null, null, null, 1, 1, 1, 2, null, 'Разработка нормативной документации для информационного сопровождения разведки и разработки газоконденсатных и нефтегазоконденсатных месторождений в области изучения газоконденсатной характеристики скважин и месторождений, планирования и мониторинга добычи полезных ископаемых', null, null, 'Субподрядное соглашение к ID=1', 3, 1, 1, null, null);
INSERT INTO ContractDoc
  (ID, Price, ContractTypeID, StartAt, EndsAt, AppliedAt, ApprovedAt, InternalNum, ContractorNum, CurrencyID, OriginContractID, NDSAlgorithmID, PrepaymentSum, PrepaymentPercent, PrepaymentNDSAlgorithmID, NDSID, ContractStateID, CurrencyMeasureID, ContractorID, IsProtectability, Subject, CurrencyRate, RateDate, Description, ContractorPersonID, IsActive, AuthorityID, PrepaymentPrecentType, Deleted) 
VALUES 
  (4, 100, 1, '01.04.2011', '15.05.2011', '28.11.2009', '01.01.2010', '53-06-1', null, 1, null, 1, null, null, null, 1, 1, 1, 3, null, 'Проведение подготовительных работ', null, null, 'Субподрядное соглашение к ID=1', 4, 1, 1, null, null);
INSERT INTO ContractDoc
  (ID, Price, ContractTypeID, StartAt, EndsAt, AppliedAt, ApprovedAt, InternalNum, ContractorNum, CurrencyID, OriginContractID, NDSAlgorithmID, PrepaymentSum, PrepaymentPercent, PrepaymentNDSAlgorithmID, NDSID, ContractStateID, CurrencyMeasureID, ContractorID, IsProtectability, Subject, CurrencyRate, RateDate, Description, ContractorPersonID, IsActive, AuthorityID, PrepaymentPrecentType, Deleted) 
VALUES 
  (5, 2000, 1, '01.01.2010', '31.12.2011', '06.05.2009', '20.05.2009', '1001-10-1/1', null, 1, 1, 1, 600, 30, 1, 1, 1, 1, 7, null, 'Разработка и внедрение новых технологических регламентов «Газораспределительные системы. Система управления сетями газораспределения»', null, null, 'Доп. соглашение к ID=1', 5, 1, null, null, null);
INSERT INTO ContractDoc
  (ID, Price, ContractTypeID, StartAt, EndsAt, AppliedAt, ApprovedAt, InternalNum, ContractorNum, CurrencyID, OriginContractID, NDSAlgorithmID, PrepaymentSum, PrepaymentPercent, PrepaymentNDSAlgorithmID, NDSID, ContractStateID, CurrencyMeasureID, ContractorID, IsProtectability, Subject, CurrencyRate, RateDate, Description, ContractorPersonID, IsActive, AuthorityID, PrepaymentPrecentType, Deleted) 
VALUES 
  (6, 100000, 1, '01.01.2005', '31.12.2005', '01.01.2005', '10.12.2004', '10-20-30-40', null, 1, null, 1, null, null, null, 1, 1, 1, 2, null, 'Удалённый договор', null, null, 'Удалённый договор', 3, null, null, null, 1);
INSERT INTO Prepayment
  (ContractDocID, Sum, "Percent", Year, ID) 
VALUES 
  (1, 300, 15, 2009, 1);
INSERT INTO Prepayment
  (ContractDocID, Sum, "Percent", Year, ID) 
...
VALUES 
  (1, 7, 'Акт закрытия', 1);
INSERT INTO Act
  (ID, Num, SignDate, ActTypeID, NDSID, RegionID, TotalSum, SumForTransfer, Status, EnterpriceAuthorityID, CurrencyRate, RateDate, NdsalgorithmID, CurrencyID, CurrencymeasureID) 
VALUES 
  (1, '143-23', '01.01.2011', 1, 1, 1, 200, 200, 1, 1, null, null, null, null, null);
...
VALUES 
  (1, '1', 'Анализ CEN/TS 15399:2007 и CEN/TS 15173:2006 и действующих нормативных документов РФ в области газораспределения. Определение структуры и разделов проекта стандарта. Обсуждение итогов работы  рабочей группой ', '05.07.2010 ', '18.10.2010', 200, 1, null, 1, 1, '23', 1);
INSERT INTO Stage
  (ID, Num, Subject, StartsAt, EndsAt, Price, NdsAlgorithmID, ParentID, ActID, ScheduleID, Code, NdsID) 
VALUES 
  (2, '2', 'Разработка первой редакции проекта стандарта «Газораспределительные системы. Система управления сетями газораспределения» Обсуждение первой редакции проекта стандарта рабочей группой. ', '18.10.2010', '27.12.2010', 600, 1, null, 1, 1, '4', 1);
INSERT INTO Stage
  (ID, Num, Subject, StartsAt, EndsAt, Price, NdsAlgorithmID, ParentID, ActID, ScheduleID, Code, NdsID) 
VALUES 
  (3, '3', 'Оформление уведомления о разработке стандарта и его публикация. Публикация проекта стандарта в информационной системе общего пользования в электронно-цифровой форме для проведения публичного обсуждения. Сбор замечаний и предложений, полученных при публичном обсуждении проекта стандарта. ', '10.01.2011', '15.05.2011', 200, 1, null, null, 1, '5', 1);
INSERT INTO Stage
  (ID, Num, Subject, StartsAt, EndsAt, Price, NdsAlgorithmID, ParentID, ActID, ScheduleID, Code, NdsID) 
VALUES 
  (4, '4', 'Внесение изменений и дополнений в проект и подготовка окончательной редакции стандарта. Обсуждение окончательной редакции проекта стандарта рабочей группой. ', '01.04.2011', '30.09.2011', 600, 1, null, null, 1, '6', 1);
INSERT INTO Stage
  (ID, Num, Subject, StartsAt, EndsAt, Price, NdsAlgorithmID, ParentID, ActID, ScheduleID, Code, NdsID) 
VALUES 
  (5, '5', 'Передача в ПК 4 проекта стандарта «Газораспределительные системы. Система управления сетями газораспределения» для организации экспертизы секретариатом ТК 23.', '01.10.2011', '25.12.2011', 400, 1, null, null, 1, '2', 1);
INSERT INTO Stage
  (ID, Num, Subject, StartsAt, EndsAt, Price, NdsAlgorithmID, ParentID, ActID, ScheduleID, Code, NdsID) 
VALUES 
  (6, '1.1', 'Анализ CEN/TS 15399:2007 и CEN/TS 15173:2006 и действующих нормативных документов РФ в области газораспределения. ', '05.07.2010', '01.09.2010', 90, 1, 9, null, 2, '4', 1);
INSERT INTO Stage
  (ID, Num, Subject, StartsAt, EndsAt, Price, NdsAlgorithmID, ParentID, ActID, ScheduleID, Code, NdsID) 
VALUES 
  (7, '1.2', 'Определение структуры и разделов проекта стандарта.', '01.09.2010', '01.10.2010', 10, 1, 9, null, 2, '5', 1);
INSERT INTO Stage
  (ID, Num, Subject, StartsAt, EndsAt, Price, NdsAlgorithmID, ParentID, ActID, ScheduleID, Code, NdsID) 
VALUES 
  (8, '1.3', 'Обсуждение итогов работы  рабочей группой.', '01.10.2010', '18.10.2010', 10, 1, null, null, 2, '6', 1);
INSERT INTO Stage
  (ID, Num, Subject, StartsAt, EndsAt, Price, NdsAlgorithmID, ParentID, ActID, ScheduleID, Code, NdsID) 
VALUES 
  (9, '1', 'Анализ CEN/TS 15399:2007 и CEN/TS 15173:2006 и действующих нормативных документов РФ ', '05.07.2010', '18.10.2010', 110, 1, null, null, 2, '2', 1);
...
INSERT INTO SubGeneralHierarchi
  (GeneralContractDocStageID, SubContractDocStageID, ID) 
VALUES 
  (1, 6, 1);
INSERT INTO SubGeneralHierarchi
  (GeneralContractDocStageID, SubContractDocStageID, ID) 
