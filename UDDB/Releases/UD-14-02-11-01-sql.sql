...
Скрипт сгенерирован 04:37:30 PM 13/02/2011
*/
...
CREATE SEQUENCE seq_EfficParameter_StageResult;
...
VALUES 
  (1, '1', 'Анализ CEN/TS 15399:2007 и CEN/TS 15173:2006 и действующих нормативных документов РФ в области газораспределения. Определение структуры и разделов проекта стандарта. Обсуждение итогов работы  рабочей группой ', '05.07.2010 ', '18.10.2010', 200, 1, null, 1, 1, null);
INSERT INTO Stage
  (ID, Num, Subject, StartsAt, EndsAt, Price, NdsAlgorithmID, ParentID, ActID, ScheduleID, Code) 
VALUES 
  (2, '2', 'Разработка первой редакции проекта стандарта «Газораспределительные системы. Система управления сетями газораспределения» Обсуждение первой редакции проекта стандарта рабочей группой. ', '18.10.2010', '27.12.2010', 600, 1, null, 1, 1, null);
INSERT INTO Stage
  (ID, Num, Subject, StartsAt, EndsAt, Price, NdsAlgorithmID, ParentID, ActID, ScheduleID, Code) 
VALUES 
  (3, '3', 'Оформление уведомления о разработке стандарта и его публикация. Публикация проекта стандарта в информационной системе общего пользования в электронно-цифровой форме для проведения публичного обсуждения. Сбор замечаний и предложений, полученных при публичном обсуждении проекта стандарта. ', '10.01.2011', '15.05.2011', 200, 1, null, null, 1, null);
INSERT INTO Stage
  (ID, Num, Subject, StartsAt, EndsAt, Price, NdsAlgorithmID, ParentID, ActID, ScheduleID, Code) 
VALUES 
  (4, '4', 'Внесение изменений и дополнений в проект и подготовка окончательной редакции стандарта. Обсуждение окончательной редакции проекта стандарта рабочей группой. ', '01.04.2011', '30.09.2011', 600, 1, null, null, 1, null);
INSERT INTO Stage
  (ID, Num, Subject, StartsAt, EndsAt, Price, NdsAlgorithmID, ParentID, ActID, ScheduleID, Code) 
VALUES 
  (5, '5', 'Передача в ПК 4 проекта стандарта «Газораспределительные системы. Система управления сетями газораспределения» для организации экспертизы секретариатом ТК 23.', '01.10.2011', '25.12.2011', 400, 1, null, null, 1, null);
INSERT INTO Stage
  (ID, Num, Subject, StartsAt, EndsAt, Price, NdsAlgorithmID, ParentID, ActID, ScheduleID, Code) 
VALUES 
  (6, '1.1', 'Анализ CEN/TS 15399:2007 и CEN/TS 15173:2006 и действующих нормативных документов РФ в области газораспределения. ', '05.07.2010', '01.09.2010', 90, 1, 9, null, 2, null);
INSERT INTO Stage
  (ID, Num, Subject, StartsAt, EndsAt, Price, NdsAlgorithmID, ParentID, ActID, ScheduleID, Code) 
VALUES 
  (7, '1.2', 'Определение структуры и разделов проекта стандарта.', '01.09.2010', '01.10.2010', 10, 1, 9, null, 2, null);
INSERT INTO Stage
  (ID, Num, Subject, StartsAt, EndsAt, Price, NdsAlgorithmID, ParentID, ActID, ScheduleID, Code) 
VALUES 
  (8, '1.3', 'Обсуждение итогов работы  рабочей группой.', '01.10.2010', '18.10.2010', 10, 1, null, null, 2, null);
INSERT INTO Stage
  (ID, Num, Subject, StartsAt, EndsAt, Price, NdsAlgorithmID, ParentID, ActID, ScheduleID, Code) 
VALUES 
  (9, '1', 'Анализ CEN/TS 15399:2007 и CEN/TS 15173:2006 и действующих нормативных документов РФ ', '05.07.2010', '18.10.2010', 110, 1, null, null, 2, null);
