...
DROP SEQUENCE seq_Act_PaymentDocument;
DROP SEQUENCE seq_TransferAct_Act_Document;
DROP SEQUENCE seq_EfficienceParameter_Type;


/*
Система учёта договоров 1.0.0.9
Скрипт сгенерирован 10:56:46 PM 04/03/2011
*/
...
VALUES 
  (1, 7, 'Акт закрытия', 1);
INSERT INTO Act
  (ID, Num, SignDate, ActTypeID, NDSID, RegionID, TotalSum, SumForTransfer, Status, EnterpriceAuthorityID, CurrencyRate, RateDate) 
VALUES 
...
ALTER TABLE EfficienceParameterType ADD CONSTRAINT FKEfficience269842 FOREIGN KEY (EconomEfficiencyParameterID) REFERENCES EconomEfficiencyParameter (ID);
ALTER TABLE EfficienceParameterType ADD CONSTRAINT FKEfficience747914 FOREIGN KEY (EconomEfficiencyTypeID) REFERENCES EconomEfficiencyType (ID);
...
ALTER TABLE EfParameterStageResult ADD CONSTRAINT FKEfParamete943607 FOREIGN KEY (StageResultID) REFERENCES StageResult (ID);
