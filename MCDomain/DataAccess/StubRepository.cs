...
namespace MCDomain.DataAccess
{
    public class StubContractRepository : IContractRepository, IDisposable
    {
        ...
        private readonly List<Disposal> _disposals = default(List<Disposal>);
        private readonly List<Filterstate> _filterstates; 
        ...
        private readonly List<Contractortype> _contractortype = new List<Contractortype>
                                                          {
                                                              new Contractortype {Id = 1, Name = "Другие организации"},
                                                              new Contractortype {Id = 2, Name = "Дочерние организации"},
                                                              new Contractortype {Id = 3, Name = "ОАО \"Газпром\""},
                                                              new Contractortype {Id = 4, Name =  "Физические лица"}
                                                          };
                                                                 ...
                                                                 new Contractor
                                                                     {
                                                                         ...
                                                                         Shortname = "УГТУ",
                                                                         Contractortype = new Contractortype {Id = 1, Name = "Другие организации"},
                                                                 ...
                                                                 new Contractor
                                                                     {
                                                                         ...
                                                                         Shortname = "ИНиГ",
                                                                         Contractortype = new Contractortype {Id = 2, Name = "Дочерние организации"}
                                                                     },
                                                                 new Contractor
                                                                     {
                                                                         Id = 2,
                                                                         Name = "ОАО \"Газпром\"",
                                                                         Shortname = "ВСП",
                                                                         Contractortype = new Contractortype {Id = 3, Name = "ОАО \"Газпром\""}
                                                                        
                                                                     },
                                                                new Contractor 
                                                                {
                                                                Id = 4,
                                                                Contractortype = new Contractortype {Id = 4, Name =  "Физические лица"} ,
                                                                Firstname = "Иоан",
                                                                Middlename = "Филлипович",
                                                                Familyname = "Грецько",
                                                                Inn = "1132-123-123",
                                                                Pasportnumber = "789456",
                                                                Pasportseries  = "8704"
                                                                }, 
        ...
        public StubContractRepository(List<Filterstate> filterstates)
        {
            _filterstates = filterstates;
            _transferacts = new List<Transferact>();
        ...
        private IEnumerable<Acttype> YieldActTypes()
        {
            return from int item in Enum.GetValues(typeof(WellKnownActtypes)) 
                   select new Acttype(){Id=item, Typename = ((WellKnownActtypes)item).Description()};
        }

        private IList<Acttype> _acttypes; 
        public IList<Acttype> Acttypes
        {
            get { return _acttypes??(_acttypes = YieldActTypes().ToList()); }
        }
        ...
        private IList<Transferact> _transferacts; 
        public IList<Transferact> Transferacts
        {
            get { return _transferacts; }
        }
        ...
        public IList<Contractdoc> CreateContracts()
        {
            ...
            var c4 = _contractors[3];

            var c5 = _contractors[4];
            ...
            _funccustomers[0].Parent = _funccustomers[2];
            _funccustomers[1].Parent = _funccustomers[2];
            ...
            var contract1 = new Contractdoc
                                {
                                    ...
                                    FundsResolver = new StubFundsResolver(1000, 1800000.75M),
            ...
            var contract2 = new Contractdoc
            {
                Id = 2,
                Subject =
                    "Разработка основы основ нефте-газо-лесо добывающего обеспечения для всех дочерних обществ ОАО Газпром xxx xxx xxx xxx xx xx",
                ...
                ConditionResolver =
                    new StubContractConditionResolver(ContractCondition.Closed),
                FundsResolver = new StubFundsResolver(1900.60M, 0),
            ...
            var contract3 = new Contractdoc
            {
                ...
                ConditionResolver =
                    new StubContractConditionResolver(ContractCondition.Broken),
            ...
            var contract4 = new Contractdoc
            {
                ...
                Acttype = Acttypes[4],
                ConditionResolver =
                    new StubContractConditionResolver(ContractCondition.OutOfControl),
            ...
            var contract10 = new Contractdoc
            {
                ...
                Contractstate = _states[1],
                Prepaymentsum = 1000,
                Prepaymentpercent = 2.5F,
                Enterpriseauthority = _enterpriseauthorities[1],
                
            };

            var contract22 = new Contractdoc
            {
                Id = 22,
                Subject =
                    "Тема ух-х-х-х-хххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххххх-х-х",
            ...
            contract22.Contractorcontractdocs.Add(new Contractorcontractdoc() { Contractor = c4 });
            contract22.Contractorcontractdocs.Add(new Contractorcontractdoc() { Contractor = c5 });
            contract1.Contractorcontractdocs.Add(new Contractorcontractdoc() { Contractor = c1 });
            contract2.Contractorcontractdocs.Add(new Contractorcontractdoc() { Contractor = c2 });
            contract3.Contractorcontractdocs.Add(new Contractorcontractdoc() { Contractor = c3 });
            contract4.Contractorcontractdocs.Add(new Contractorcontractdoc() { Contractor = c1 });
            contract5.Contractorcontractdocs.Add(new Contractorcontractdoc() { Contractor = c2 });
            contract10.Contractorcontractdocs.Add(new Contractorcontractdoc() { Contractor = c3 }); 
        ...
        public IList<Yearreportcolor> Yearreportcolors { get { throw new NotImplementedException(); }}
}
}
