...
namespace McUIBase.Commands
{
    ...
    public class ApplicationCommandAttribute:Attribute
    {
        ...
        public ApplicationCommandAttribute(string toolTip, string imageResource, AppCommandType cmdType = AppCommandType.Silent, string confirmMessage = "Подтвердите выполлнение команды", SeparatorType separator = SeparatorType.None)
        {
            ToolTip = toolTip;
