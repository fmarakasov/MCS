...
namespace McUIBase.ViewModel
{
    ...
    public abstract class RepositoryViewModel : ViewModelBase
    {
        ...
        public ICommand SaveCommand
        {
            get
            {
                if (_saveCommand == null)
                    _saveCommand = new RelayCommand(p => SaveChanges(), x => CanSave());
                return _saveCommand;
            }
        }
        ...
        {
            get { return UnitOfWork.Context.IsModified; }
        }

        protected IUnitOfWork UnitOfWork
        {
            get { return Repository.UnitOfWork; }
        }
        ...
        private void Submit()
        {
            ...
            {
                throw new SubmitChangesFailed("Изменения не сохранены", exception);
            }
        }
